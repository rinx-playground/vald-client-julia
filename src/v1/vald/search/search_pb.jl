...
# service methods for Search
const _Search_methods = MethodDescriptor[
        MethodDescriptor("Search", 1, payload_v1_Search_Request, payload_v1_Search_Response),
        MethodDescriptor("SearchByID", 2, payload_v1_Search_IDRequest, payload_v1_Search_Response),
        MethodDescriptor("StreamSearch", 3, Channel{payload_v1_Search_Request}, Channel{payload_v1_Search_StreamResponse}),
        MethodDescriptor("StreamSearchByID", 4, Channel{payload_v1_Search_IDRequest}, Channel{payload_v1_Search_StreamResponse}),
        MethodDescriptor("MultiSearch", 5, payload_v1_Search_MultiRequest, payload_v1_Search_Responses),
        MethodDescriptor("MultiSearchByID", 6, payload_v1_Search_MultiIDRequest, payload_v1_Search_Responses)
    ] # const _Search_methods
const _Search_desc = ServiceDescriptor("vald_v1_search.Search", 1, _Search_methods)

Search(impl::Module) = ProtoService(_Search_desc, impl)

mutable struct SearchStub <: AbstractProtoServiceStub{false}
    impl::ProtoServiceStub
    SearchStub(channel::ProtoRpcChannel) = new(ProtoServiceStub(_Search_desc, channel))
end # mutable struct SearchStub

mutable struct SearchBlockingStub <: AbstractProtoServiceStub{true}
    impl::ProtoServiceBlockingStub
    SearchBlockingStub(channel::ProtoRpcChannel) = new(ProtoServiceBlockingStub(_Search_desc, channel))
end # mutable struct SearchBlockingStub

Search(stub::SearchStub, controller::ProtoRpcController, inp::payload_v1_Search_Request, done::Function) = call_method(stub.impl, _Search_methods[1], controller, inp, done)
Search(stub::SearchBlockingStub, controller::ProtoRpcController, inp::payload_v1_Search_Request) = call_method(stub.impl, _Search_methods[1], controller, inp)

SearchByID(stub::SearchStub, controller::ProtoRpcController, inp::payload_v1_Search_IDRequest, done::Function) = call_method(stub.impl, _Search_methods[2], controller, inp, done)
SearchByID(stub::SearchBlockingStub, controller::ProtoRpcController, inp::payload_v1_Search_IDRequest) = call_method(stub.impl, _Search_methods[2], controller, inp)

StreamSearch(stub::SearchStub, controller::ProtoRpcController, inp::Channel{payload_v1_Search_Request}, done::Function) = call_method(stub.impl, _Search_methods[3], controller, inp, done)
StreamSearch(stub::SearchBlockingStub, controller::ProtoRpcController, inp::Channel{payload_v1_Search_Request}) = call_method(stub.impl, _Search_methods[3], controller, inp)

StreamSearchByID(stub::SearchStub, controller::ProtoRpcController, inp::Channel{payload_v1_Search_IDRequest}, done::Function) = call_method(stub.impl, _Search_methods[4], controller, inp, done)
StreamSearchByID(stub::SearchBlockingStub, controller::ProtoRpcController, inp::Channel{payload_v1_Search_IDRequest}) = call_method(stub.impl, _Search_methods[4], controller, inp)

MultiSearch(stub::SearchStub, controller::ProtoRpcController, inp::payload_v1_Search_MultiRequest, done::Function) = call_method(stub.impl, _Search_methods[5], controller, inp, done)
MultiSearch(stub::SearchBlockingStub, controller::ProtoRpcController, inp::payload_v1_Search_MultiRequest) = call_method(stub.impl, _Search_methods[5], controller, inp)

MultiSearchByID(stub::SearchStub, controller::ProtoRpcController, inp::payload_v1_Search_MultiIDRequest, done::Function) = call_method(stub.impl, _Search_methods[6], controller, inp, done)
MultiSearchByID(stub::SearchBlockingStub, controller::ProtoRpcController, inp::payload_v1_Search_MultiIDRequest) = call_method(stub.impl, _Search_methods[6], controller, inp)
