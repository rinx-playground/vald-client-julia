...
# service methods for Upsert
const _Upsert_methods = MethodDescriptor[
        MethodDescriptor("Upsert", 1, payload_v1_Upsert_Request, payload_v1_Object_Location),
